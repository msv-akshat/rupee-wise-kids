...
const ParentExpenseView = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      ...
      try {
        setIsLoading(true);
        console.log("Fetching parent expenses for user:", currentUser.uid);
        ...
        console.log("Parent expenses snapshot size:", expensesSnapshot.size);
        ...
        console.log("Processed parent expenses data:", expensesData);
...
export default ParentExpenseView;
